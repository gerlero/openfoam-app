...
_Intel Mac? Running an older version of macOS? [See here](#-qa)_
...
<details><summary><b>Can I use this app on my Intel Mac?</b></summary>

Intel-based Macs are no longer supported by this project. The last release compatible with Intel CPUs is [**OpenFOAM.app** 2.1.2](https://github.com/gerlero/openfoam-app/releases/tag/v2.1.2); you can install up to OpenFOAM v2506 through that release:
...
[Building the app from source](#-building-from-source) for a newer OpenFOAM version on an Intel-based Mac may or may not work (and I likely won't be able to help you).
</details>
